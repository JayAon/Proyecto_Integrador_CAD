...
const handleNewPrediction = (formData: any, result: { duracion: number }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white flex items-start justify-center gap-6 p-4">
  {/* Formulario */}
  <div className="bg-white dark:bg-gray-800 p-8 rounded shadow-md w-full max-w-xl">
    {
      <div className="bg-white dark:bg-gray-800 p-8 rounded shadow-md w-full max-w-xl">
        <div className="mb-6">
...
<form className="grid grid-cols-1 md:grid-cols-2 gap-6" onSubmit={handleSubmit}>
  ...
  {/* Fabricadas */}
  <div className="mb-4 col-span-2 mx-auto w-full max-w-xs">
  ...
  <button
  type="submit"
  className={`relative overflow-hidden col-span-2 bg-blue-600  dark:bg-blue-500  text-white font-semibold py-2 px-4 rounded transition ${isLoading ? 'opacity-70 cursor-not-allowed' : 'hover:bg-blue-700 dark:hover:bg-blue-400'}`}
  disabled={isLoading}
...
>
  ...
  <span className="relative z-10">
    {isLoading ? "Cargando..." : "Predecir duración"}
  </span>
</button>
</form>
